...
The dataset is from [Google Landmark Recognition Competition 2020](https://www.kaggle.com/competitions/landmark-recognition-2020/data "Click to go to this link") on Kaggle that are free to use. It has landmark images from all around the world, but we choose Indonesian landmarks only because we think this is suitable for our MVP or Minimum Viable Product. Also because of the time limit for 1 month to finish this capstone project.
How we get the Indonesian landmarks dataset only? We got this by using scraping to the website version of the Google Landmark Recognition Competition 2020, which is this https://storage.googleapis.com/gld-v2/web/index.html
